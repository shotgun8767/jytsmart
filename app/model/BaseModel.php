...
use app\model\traits\SoftDelete;
use app\model\traits\Status;
use Exception;
...
class BaseModel extends Model
{
     ...
     * @return array|Collection|BaseModel
     */
    ...
    public function inserts(array $data, $replaceWhen = false, $status = null) : int
    {
        ...
        $this->refreshQuery();
        $allFields = $this->getTableFields($this->db()->getTable());
     ...
     * 获取多条数据
     * @param null $data
     * @return array|Collection|\think\Collection
     */
